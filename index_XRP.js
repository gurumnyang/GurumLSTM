...
var trainData = JSON.parse(fs.readFileSync('trainData4_XRP.json'));

var x_raw = [];
var y_raw = [];
var seq = shuffle(Array.from(Array(1388).keys()))
    ...
    model.fit(x, y, {
        ...
        callbacks: {
            onEpochEnd: async (epoch, logs) => {
                ...
                if(epoch % 10 == 0){
                    const saveResult = model.save('file:///Users/user/Documents/GitHub/GurumCoinAi/my-model-3');
                    console.log('모델 저장됨');
                }
